"""Lost Type news crawler. Parses news page, fetches article pages for dates."""
...
class LostTypeNewsCrawler:
    ...
    def crawl(self, session, timeout: int = 20) -> list[FontNewsItem]:
        ...
        base_url = str(self.source_config.get("base_url", "https://www.losttype.com"))
        news_url = str(self.source_config.get("news_url", "https://www.losttype.com/news"))

"""Type Network articles news crawler. Fetches article pages for dates."""
...
class TypeNetworkNewsCrawler:
    ...
    def crawl(self, session, timeout: int = 20) -> list[FontNewsItem]:
        ...
        base_url = str(self.source_config.get("base_url", "https://typenetwork.com"))
        articles_url = str(self.source_config.get("news_url", "https://typenetwork.com/articles"))
        ...
        try:
            r = session.get(articles_url, timeout=timeout)
            r.raise_for_status()

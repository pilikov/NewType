"""Fontfabric blog news crawler. Uses RSS feed."""
...
class FontfabricNewsCrawler:
    ...
    def crawl(self, session, timeout: int = 20) -> list[FontNewsItem]:
        ...
        base_url = str(self.source_config.get("base_url", "https://www.fontfabric.com"))
        crawl_cfg = self.source_config.get("crawl", {})
        rss_url = str(crawl_cfg.get("rss_url", "https://www.fontfabric.com/blog/feed/"))
